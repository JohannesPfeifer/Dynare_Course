...
addpath ../../stepan/dsge-bayesian-estimation/matlab2tikz/src
...
text('Interpreter','latex',...
       ...
       'FontSize',12)
text('Interpreter','latex',...
       'String','$$ p \left(\theta^0| Y^T\right)  $$',...
       'Position',[-4.2 ff1],...
       'FontSize',12)
hold off
...
text('Interpreter','latex',...
       ...
       'FontSize',12)
text('Interpreter','latex',...
       'String','$$\theta^{1} =  \tilde \theta $$',...
       'Position',[-0.25 -0.02],...
       'FontSize',12)
text('Interpreter','latex',...
       'String','$$  p \left(\theta^1 | Y^T\right) $$',...
       'Position',[-4.6 ff2],...
       'FontSize',12)
text('Interpreter','latex',...
       'String','$$  \alpha=1 $$',...
